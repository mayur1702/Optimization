...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    // created new variable randomPizzas
    var randomPizzas=document.querySelectorAll(".randomPizzaContainer");
    //since there are only 3 size possible directly called sizeSwitcher function
    var newwidth = sizeSwitcher(size);
...
function updatePositions() {
  ...
  // Removed scrolltop from for loop as there was no need to be called every time
